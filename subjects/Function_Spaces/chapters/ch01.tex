...
\begin{proof}
    Let $s_{n} \uparrow f$ and $t_{n} \uparrow g$ almost everywhere. Note that $\min\{f,g\} \leq f,g$, so $\min\{f,g\} \in U[0,1]$. Now, $\max\{f,g\} = f+g-\min\{f,g\}$, so $\max\{f,g\} \in U[0,1]$ as well.
\end{proof}