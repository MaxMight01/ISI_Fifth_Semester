...
\begin{titlepage}
    ...
    \begin{center}
        \vspace*{\fill}
        {\Huge\bfseries\color{black!90} \MakeUppercase{Representation Theory of Finite Groups}\par}
        \vspace{0.5cm}
        {\Large\color{black!90} Subhajit Jana, notes by Ramdas Singh\par}
        \vspace{0.5cm}
        {\large\color{black!90} Fifth Semester\par}
        \vspace*{\fill}
    \end{center}
\end{titlepage}
